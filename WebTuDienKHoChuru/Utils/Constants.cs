namespace WebTuDienKHoChuru.Utils
{
	public static class Constants
	{
		...
		public const string ListExamples = "Danh sách ví dụ cần ghi âm";
		public const string ListPassages = "Danh sách đoạn văn";
		public const string ImportFile = "Nhập dữ liệu từ tập tin .TSV";
